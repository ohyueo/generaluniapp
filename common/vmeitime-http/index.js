...
export const shoplistindex = (data) => {
    return http.request({
...
export const getytimelist = (data) => {
    return http.request({
...
export const merorderlist = (data) => {
    return http.request({
...
export default {
	...
	setpaylist,
	yuelist,
	getinvitation,addcode,invitalist,addinvata,getinvata,mapdistance,seatlist,shoporder,
	textinfo,texterlist,shoplistindex,getshop,shop_info,addshop,shopord,shopordinfo,querenorder,getperson,getytimelist,
	platelist,
	platetime,
	merlist,merorderlist,
	addsignin,setdefaultlist
}