	...
	<view class="u-padding-20">
		...
		<view class="" v-if="status>0">
			...
			<view class="centxs u-margin-top-30">
				...
				<view class="topvix u-flex" v-if="list.heno>0">
					<view class="" style="width: 200rpx;">
						<text class="u-font-24 u-color-balck3">已核销次数</text>
					</view>
					<text class="u-font-24 u-color-balck3">{{list.heno}}</text>
				</view>
				<view class="topvix u-flex" v-if="list.number>0">
					<view class="" style="width: 200rpx;">
						<text class="u-font-24 u-color-balck3">预约人数</text>
					</view>
					<text class="u-font-24 u-color-balck3">{{list.number}}</text>
				</view>
