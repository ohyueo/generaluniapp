<template>
	<view>
		...
		<view class="u-padding-20" style="padding-bottom:0px;position: absolute;top: 200rpx;width: 710rpx;">
			<view class="u-flex-col u-bg-white" style="border-radius:10px;">
				...
				<view class="u-flex u-padding-20">
					<view class="u-flex-col u-flex-1 u-row-center u-col-center u-rela" @click="tiao('../order/myorder?type=1')" v-if="paymsg==1">
						<text class="icon u-font-42 zhuti_color">&#xe60e;</text>
		...
		<view class="userlist u-flex-col u-margin-top-20" style="margin-top: 190rpx;">
			<view class="userli u-flex u-row-between u-bg-white" @click="tiao('/merchant/user/auth')">
				<view class="iconlist u-flex u-row-center u-col-center">
					<i class="icon u-font-44 zhuti_color">&#xe63c;</i>
				</view> 
				<view class="user_cent">
					<span class="u-font-28 u-color-balck3">商家入驻</span>
				</view>
				<text class="icon u-color-balck9">&#xe623;</text>
			</view>
			<view class="userli u-flex u-row-between u-bg-white" @click="tiao('./defaultlist')">
				<view class="iconlist u-flex u-row-center u-col-center">
					<i class="icon u-font-44 zhuti_color">&#xe63c;</i>
				</view>
				<view class="user_cent">
					<span class="u-font-28 u-color-balck3">违约记录</span>
				</view>
				<text class="icon u-color-balck9">&#xe623;</text>
			</view>
			<view class="userli u-flex u-row-between" @click="tiao('../shop/myorder')" v-if="isshop==1">
				<view class="iconlist u-flex u-row-center u-col-center">
					<text class="icon u-font-40 zhuti_color">&#xe699;</text>
				</view>
				<view class="user_cent">
					<text class="u-font-28 u-color-balck3">商城订单</text>
				</view>
				<text class="icon u-color-balck9">&#xe623;</text>
			</view>
			...
			<view class="userli u-flex u-row-between u-bg-white" @click="tiao('../pay/paylist')" v-if="paymsg==1">
				<view class="iconlist u-flex u-row-center u-col-center">
					<i class="icon u-font-44 zhuti_color">&#xe63c;</i>
				</view>
				<view class="user_cent">
			...
			<view v-if="xiao==1" class="userli u-flex u-row-between" @click="tiao('../merch/hexiaolist')">
				<view class="iconlist u-flex u-row-center u-col-center">
					<text class="icon u-font-38 zhuti_color">&#xe6fd;</text>
				</view>
				<view class="user_cent">
					<text class="u-font-28 u-color-balck3">核销中心</text>
				</view>
				<text class="icon u-color-balck9">&#xe623;</text>
			</view>
		...
		methods: {
			...
			getData() {
				...
				this.$api.user_info({token: this.token}).then(res => {
					...
					_this.paymsg=res.data.data.paymsg;
